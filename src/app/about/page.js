...
const page = () => {
  return <div className="flex gap-16 w-full">
    <div className="flex-1 flex gap-8 flex-col">
      <p className="text-blue-500 font-semibold text-xl">About Agency</p>
      <h1 className="text-[2.25rem] md:text-[2.75rem] font-bold leading-[50px] md:leading-[60px]">We create digital ideas that are bigger, bolder, braver and better.</h1>
      ...
      <div className="flex justify-between items-center gap-4">
        <div>
          ...
          <p className="text-sm  md:w-fit md:text-base">Years of experience</p>
        </div>

        <div>
          <h1 className="text-blue-500 font-bold text-xl md:text-2xl">234 K+</h1>
          <p className="text-sm md:w-fit md:text-base">People reached</p>
        </div>

        <div>
          <h1 className="text-blue-500 font-bold text-xl md:text-2xl">5 K+</h1>
          <p className="text-sm md:w-fit md:text-base">Services and plugins</p>
        </div>
      </div>
    </div>
